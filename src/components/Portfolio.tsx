          ...
          >
            ...
            <div className="pr-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="font-[family-name:var(--font-dm-mono)] text-[.56rem] tracking-[.18em] uppercase text-[var(--gold)] px-3 py-1 bg-[--white] border border-[var(--ink-faint)] rounded-full">{p.cat}</div>
              </div>
